...
void login::on_pushButton_3_clicked()
{
    // Fermer le port série si ouvert
        ...
        if (post == "Ressources humaines") {
            ...
            maStock->show();
        } else if (post == "Fournisseur") {  // Ajout pour le fournisseur
            fournisseurUI *fournisseur = new fournisseurUI(this);
            fournisseur->show();
        } else if (post == "Ordonnances") {  // Ajout pour ordonnance
            ordonnanceUI *ordonnance = new ordonnanceUI(this);
            ordonnance->show();
        } else {
            QMessageBox::critical(nullptr, QObject::tr("Non valide"),

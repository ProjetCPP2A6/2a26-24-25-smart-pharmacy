...
void statistique::closeEvent(QCloseEvent *event)
{
    // Si vous voulez empêcher la fermeture accidentelle de la fenêtre, vous pouvez annuler l'événement ici.
    event->ignore();  // Si vous voulez annuler la fermeture, utilisez ignore.
    // Ou si vous voulez effectuer une action avant la fermeture, vous pouvez le faire ici.
}
